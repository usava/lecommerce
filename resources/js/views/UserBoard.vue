        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <br>
                    <div class="row">
                        <div @key="index" class="col-md-4 product-box" v-for="(order, index) in orders">
                            <img :alt="order.product.name" :src="order.product.image">
                            <h5>
                            ...
                            <span class="small-text text-muted">Quantity: {{order.quantity}}
                                <span class="float-right">{{order.status == 3 ? 'shipped!' : 'no shipped'}}</span>
                            </span>
                            <br><br>
